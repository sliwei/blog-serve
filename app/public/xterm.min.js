  ...
  })(
    {
      ...
      2: [
        function (e, t, i) {
          ...
          var s =
            ((o.prototype.getNullCell = function (e) {
              return (
                e
      ...
      3: [
        function (e, t, i) {
          ...
          var r = e('./Buffer'),
            ...
            s =
              (Object.defineProperty(o.prototype, 'onBufferActivate', {
                get: function () {
      ...
      4: [
        function (e, t, i) {
          ...
          var r = e('./common/EventEmitter2'),
            n =
              (Object.defineProperty(s.prototype, 'onCharSizeChanged', {
                get: function () {
      ...
      8: [
        function (e, t, i) {
          ...
          var u =
            ((f.prototype.hook = function (e, t, i) {}),
      ...
      9: [
        function (e, t, i) {
          ...
          var o = e('./common/data/EscapeSequences'),
            ...
            u = { '(': 0, ')': 1, '*': 2, '+': 3, '-': 1, '.': 2 },
            f =
              ((_.prototype.hook = function (e, t, i) {
            ...
            g =
              ...
              (C.prototype.charAttributes = function (e) {
                if (1 === e.length && 0 === e[0])
                  return (
                    ...
                    void (this._terminal.curAttrData.bg =
                      y.DEFAULT_ATTR_DATA.bg)
                  )
                for (
              ...
              (C.prototype.saveCursor = function (e) {
                ;(this._terminal.buffer.savedX = this._terminal.buffer.x),
                  ...
                  (this._terminal.buffer.savedCurAttrData.fg =
                    this._terminal.curAttrData.fg),
                  (this._terminal.buffer.savedCurAttrData.bg =
      ...
      10: [
        function (e, t, i) {
          ...
          var u = e('./MouseZoneManager'),
            ...
            n =
              (Object.defineProperty(a.prototype, 'onLinkHover', {
                get: function () {
              ...
              (h.prototype._onMouseDown = function (e) {
                if (
                  ((this._initialSelectionLength =
                    this._terminal.getSelection().length),
                  this._areZonesActive)
                ) {
                  var t = this._findZoneEventAt(e)
                  t &&
      ...
      13: [
        function (e, t, i) {
          ...
          var r = e('./MouseHelper'),
            ...
            c = new RegExp(h, 'g'),
            u =
              (Object.defineProperty(f.prototype, 'onLinuxMouseSelection', {
                get: function () {
              ...
              (f.prototype.initBuffersListeners = function () {
                var t = this
                ;(this._trimListener = this._terminal.buffer.lines.onTrim(
                  function (e) {
                    return t._onTrim(e)
                  }
                )),
              ...
              (f.prototype._onDoubleClick = function (e) {
                var t = this._getMouseBufferCoords(e)
                t &&
                  ((this._activeSelectionMode = 1), this._selectWordAt(t, !0))
              }),
              ...
              (f.prototype._convertViewportColToCharacterIndex = function (
                e,
                t
              ) {
                ...
                return e > this._terminal.cols
                  ? [
                      ...
                      this.selectionStart[1] +
                        Math.floor(e / this._terminal.cols)
                    ]
            ...
            F =
                ...
                this._bindKeys(),
                  this.register(
                    C.addDisposableDomListener(
                      ...
                      function (e) {
                        t.hasSelection() &&
                          u.copyHandler(e, t, t.selectionManager)
                      }
                    )
                  ),
                  this.register(
              ...
              (I.prototype.open = function (e) {
                ...
                ;(this._renderCoordinator = new H.RenderCoordinator(
                  ...
                  (this.mouseHelper = new b.MouseHelper(
                    this._renderCoordinator
                  )),
              ...
              (I.prototype._setTheme = function (e) {
                ;(this._theme = e),
                  ...
                  this._renderCoordinator &&
                    this._renderCoordinator.setColors(
      ...
      20: [
        function (e, t, i) {
          ...
          var r = e('./EventEmitter2'),
            n =
              (Object.defineProperty(s.prototype, 'onDelete', {
                get: function () {
      ...
      23: [
        function (e, t, i) {
          ...
          Object.defineProperty(i, '__esModule', { value: !0 })
          var r =
            (Object.defineProperty(n.prototype, 'event', {
              get: function () {
                var i = this
                return (
                  this._event ||
                  ...
                  if ((i && !r) || !e.altKey || e.metaKey)
                    i && !e.altKey && !e.ctrlKey && e.metaKey
                      ...
                      : e.key &&
                        ...
                        1 === e.key.length
                      ? (n.key = e.key)
                      : e.key && e.ctrlKey && '_' === e.key && (n.key = h.C0.US)
                  else {
                    var o = c[e.keyCode],
      ...
      37: [
        function (e, t, i) {
          ...
          var r = e('../Terminal'),
            ...
            s = e('./AddonManager'),
            o =
              (Object.defineProperty(a.prototype, 'onCursorMove', {
                get: function () {
          ...
          i.Terminal = o
          var l =
            (Object.defineProperty(h.prototype, 'cursorY', {
              get: function () {
          ...
          var c =
            (Object.defineProperty(u.prototype, 'isWrapped', {
              get: function () {
          ...
          var f =
            (Object.defineProperty(_.prototype, 'char', {
              get: function () {
                ...
                if (
                  ...
                  t.isBgDefault()
                    ...
                    ? (this._ctx.fillStyle =
                        ...
                        ')')
                    : (this._ctx.fillStyle =
                        this._colors.ansi[t.getBgColor()].css)
      ...
      52: [
        function (e, t, i) {
          ...
          Object.defineProperty(i, '__esModule', { value: !0 })
          var r =
            ((n.prototype._unlinkNode = function (e) {
              var t = e.prev,
                i = e.next
          ...
          var s,
            ...
            u =
              ...
              (f.prototype.draw = function (e, t, i, r) {
                ...
                e.save()
                var s =
                    this._config.scaledCharWidth + a.CHAR_ATLAS_CELL_SPACING,
                ...
                ;(this.dimensions.scaledCharWidth =
                  ...
                  this._rowElements.forEach(function (e) {
                    ;(e.style.width = t.dimensions.canvasWidth + 'px'),
                      ...
                      (e.style.lineHeight =
                        t.dimensions.actualCellHeight + 'px'),
      ...
      57: [
        function (e, t, p) {
          ...
          var i =
            ((r.prototype.createRow = function (e, t, i, r, n, s, o) {
              for (
                ...
                if (
                  e.loadCell(h, this._workCell).getCode() !==
                    y.NULL_CELL_CODE ||
                  (t && h === r)
                ) {
                  l = h + 1
                ...
                if (0 !== c) {
                  ...
                  this._workCell.isBold() &&
                    ...
                    this._workCell.isItalic() &&
                      u.classList.add(p.ITALIC_CLASS),
