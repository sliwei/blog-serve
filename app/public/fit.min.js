      ...
      1: [
        function (e, t, r) {
          ...
          function o(e) {
            ...
            return {
              cols: Math.floor(
                l / e._core._renderCoordinator.dimensions.actualCellWidth
              ),
              rows: Math.floor(
                i / e._core._renderCoordinator.dimensions.actualCellHeight
              )
            }
          }
          function n(e) {
            var t = o(e)
            t &&
              ((e.rows === t.rows && e.cols === t.cols) ||
                (e._core._renderCoordinator.clear(), e.resize(t.cols, t.rows)))
          }
